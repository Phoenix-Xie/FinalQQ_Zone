<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="adddiary.aspx.cs" Inherits="adddiary" %>
...
background-image: -webkit-gradient(linear,left bottom,left top,color-start(0, #a8edea),color-stop(1, #fed6e3));">-->
    <div class = "gaoxiao" style="position:absolute;z-index:2;">
        ...
        <a href="friends.aspx" style="color: black;">好友</a><br />
          ...
          标题：<asp:TextBox ID="DiaryTitle" runat="server"></asp:TextBox>
   <!-- 配置文件 -->
    ...
    <script type="text/javascript" >
        ...
        ue.render("<%=Diary.ClientID%>")
    </script>

    <textarea id="Diary" name="Passage" runat="server"></textarea>
