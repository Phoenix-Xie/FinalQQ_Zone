<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="addmessagecomment.aspx.cs" Inherits="addmessagecomment" %>
...
background-image: -webkit-gradient(linear,left bottom,left top,color-start(0, #a8edea),color-stop(1, #fed6e3));">-->
   ...
   <!-- 配置文件 -->
    ...
    <script type="text/javascript" >
        ...
        ue.render("<%=Comment.ClientID%>")
    </script>

    <textarea id="Comment" name="Comment" runat="server"></textarea>
